...
const _releases: Release[] = [
  ...
  },
  {
    ...
    tag_name: 'v1.2.0',
    target_commitish: 'main',
    assets: [{name: 'a.txt', download_count: 10}]
  },
  {
    id: 3,
    _downloads: 0,
  ...
  },
  {
    id: 9,
    _downloads: 0,
    tag_name: 'v1.1.0-fix-demo.1',
    target_commitish: 'fix-demo',
    assets: [{name: 'a.txt', download_count: 10}]
  },
  {
    id: 10,
    _downloads: 0,
    tag_name: 'v1.1.0-oldone.1',
    target_commitish: 'main',
    assets: [
...
describe('Release action parser', () => {
  ...
  test('error -> parse-nightmare', () => {
    let bt = new BranchTask(
      '@main: keeper===4,,,,downwhat<>4,',
      '@main',
      _releases
    )
